#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Для примера 1 лабораторной работы 2.17 реализуйте возможность хранения
# данных в базе данных SQLite3.
# При решении задачи будем хранить данные о должностях в таблице posts, а данные о
# работниках в таблице workers. При каждом запуске программы будет проверяться наличие
# файла базы данных, и если такого файла нет, то он будет создан вместе с соответствующими
# таблицами. Для работы с датой и временем используются средства языка SQL SQLite3.
